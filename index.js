...
function printIndexes(array) {
  ...
  for (const prnIndex in array) {
    // Виводимо кожен індекс на консоль
    console.log(prnIndex);
  }
}
...
function replaceNumbers(arr) {
  ...
  for (let i = 0; i < arr.length; i++) {
    ...
    // Якщо число менше або дорівнює 10, додаємо рядок  до масиву результату
    else {
      a = [...a, "Less than or equal to 10"];
    }
  }
